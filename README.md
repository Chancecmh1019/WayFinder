...
- 當前版本：v1.1.0 (Build 2)
- 資料庫版本：GSAT-English v7.0.0
- 詞彙量：7,177 單字 + 2,866 片語 + 28 文法句型
...
- **學習輔助**：100% 覆蓋率的搭配詞、用法說明、文法規則、常見錯誤
...
```dart
{
  ...
  "collocations": [搭配詞],  // v7.0.0 100% 覆蓋
  "usage_notes": "用法說明",  // v7.0.0 100% 覆蓋
  "grammar_notes": "文法規則",  // v7.0.0 100% 覆蓋
  "common_mistakes": "常見錯誤"  // v7.0.0 100% 覆蓋
}
```
